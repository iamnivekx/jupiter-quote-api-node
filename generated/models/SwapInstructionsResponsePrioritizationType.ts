...
import type { SwapInstructionsResponsePrioritizationTypeComputeBudget } from './SwapInstructionsResponsePrioritizationTypeComputeBudget';
import {
    SwapInstructionsResponsePrioritizationTypeComputeBudgetFromJSON,
    SwapInstructionsResponsePrioritizationTypeComputeBudgetFromJSONTyped,
    SwapInstructionsResponsePrioritizationTypeComputeBudgetToJSON,
} from './SwapInstructionsResponsePrioritizationTypeComputeBudget';

/**
 * - Information about the prioritization fee type and amounts.
 * 
 * @export
...
export interface SwapInstructionsResponsePrioritizationType {
    /**
     * 
     * @type {SwapInstructionsResponsePrioritizationTypeComputeBudget}
     * @memberof SwapInstructionsResponsePrioritizationType
     */
    computeBudget?: SwapInstructionsResponsePrioritizationTypeComputeBudget;
}
...
export function SwapInstructionsResponsePrioritizationTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SwapInstructionsResponsePrioritizationType {
    ...
    return {
        ...
        'computeBudget': !exists(json, 'computeBudget') ? undefined : SwapInstructionsResponsePrioritizationTypeComputeBudgetFromJSON(json['computeBudget']),
    };
}
...
export function SwapInstructionsResponsePrioritizationTypeToJSON(value?: SwapInstructionsResponsePrioritizationType | null): any {
    ...
    return {
        ...
        'computeBudget': SwapInstructionsResponsePrioritizationTypeComputeBudgetToJSON(value.computeBudget),
    };
}
